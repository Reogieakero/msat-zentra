...
class MockData {
  ...
  // Mock ADM Classwork Items
  static final List<AdmClassworkModel> admClasswork = [
    AdmClassworkModel(
      id: 'cw_01',
      subjectName: 'Mathematics 10',
      title: 'Diagnostic Activity Sheet: Pre-Algebra & Equations',
      ...
      submittedCount: 3,
      gradedCount: 2,
      instructions: 'Complete all 10 problem sets on linear equations and submit step-by-step solutions.',
    ),
    AdmClassworkModel(
      id: 'cw_02',
      subjectName: 'Mathematics 10',
      title: 'Written Work 1: Quadratic Functions & Graphs',
      topic: 'Quarter 1 - Core Competencies',
      type: AdmClassworkType.assignment,
      totalPoints: 50,
      dueDate: DateTime.now().add(const Duration(days: 7)),
      assignedCount: 4,
      submittedCount: 2,
      gradedCount: 1,
      instructions: 'Graph the given quadratic equations and identify vertex, axis of symmetry, and intercepts.',
    ),
    AdmClassworkModel(
      id: 'cw_03',
      subjectName: 'Mathematics 10',
      title: 'Formative Assessment: Polynomial Operations',
      topic: 'Quarter 1 - Core Competencies',
      type: AdmClassworkType.quiz,
      totalPoints: 30,
      dueDate: DateTime.now().add(const Duration(days: 10)),
      assignedCount: 4,
      submittedCount: 1,
      gradedCount: 0,
      instructions: '15-item quiz evaluating synthetic division, remainder theorem, and polynomial roots.',
    ),
    AdmClassworkModel(
      id: 'cw_04',
      subjectName: 'Mathematics 10',
      title: 'Remedial Project: Real-World Math Modeling',
      topic: 'Intervention & Remediation',
      type: AdmClassworkType.project,
      totalPoints: 100,
      dueDate: DateTime.now().add(const Duration(days: 14)),
      assignedCount: 4,
      submittedCount: 0,
      gradedCount: 0,
      instructions: 'Construct a real-world math model applying parabolic curves to arch architecture or projectile trajectories.',
    ),
    AdmClassworkModel(
      id: 'cw_05',
      subjectName: 'General Math 11',
      title: 'Activity Sheet 1: Piecewise Functions in Real Life',
      topic: 'Intervention & Remediation',
      type: AdmClassworkType.activitySheet,
      totalPoints: 25,
      ...
      submittedCount: 1,
      gradedCount: 1,
      instructions: 'Model jeepney fare functions and electricity consumption tiers using piecewise functions.',
    ),
    AdmClassworkModel(
      id: 'cw_06',
      subjectName: 'Mathematics 9',
      title: 'Quiz 1: Radical Expressions & Exponents',
      topic: 'Quarter 1 - Core Competencies',
      type: AdmClassworkType.quiz,
      totalPoints: 40,
      ...
      submittedCount: 2,
      gradedCount: 2,
      instructions: 'Simplify radicals and solve equations with rational exponents.',
    ),
  ];
}
