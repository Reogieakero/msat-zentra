...
export function AccountsAudit() {
  ...
  const { data, isPending } = useQuery({
    queryKey: ["record-keeper-accounts-audit", page],
    queryFn: () =>
      apiClient
        .get<AuditResponse>("/api/record-keeper/accounts-audit", {
        ...
        <div className={pageStyles.headerText}>
          ...
          <CardDescription className="mt-1">
            {total === 0
              ...
              : `${total} ${total === 1 ? "action" : "actions"} — approvals & rejections processed.`}
          </CardDescription>
        </div>
