...
const SLIDES: Slide[] = [
  {
    ...
    body: "Review student accounts awaiting record keeper sign-off.",
  },
  {
    icon: UserCheck,
  ...
  },
  {
    ...
    body: "See account coverage across every G7–10 section.",
  },
  {
    icon: KeyRound,
    title: "Credentials",
    ...
    <div className={styles.hero}>
      <div className={`${styles.heroPanel} ${styles.heroPanelTitle}`}>
        ...
        <p className={styles.heroSubtitle}>
          Manage G7–10 student and staff account access — approve pending
