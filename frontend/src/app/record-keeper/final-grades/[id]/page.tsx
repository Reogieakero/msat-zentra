    ...
    <section className="space-y-4 lg:space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          size="sm"
          className="h-8"
          onClick={() => router.push("/record-keeper/final-grades")}
        >
          ...
          <div className="space-y-4 lg:space-y-6 lg:col-span-2">
            ...
            <section>
              ...
              <div className="text-muted-foreground leading-relaxed whitespace-pre-line">
                {showFullAbout
                  ? `This is the complete final grade set for ${student.name} (${student.term}). All ${totalSubjects} subject(s) — ${student.subjects.map((s) => s.subject).join(", ")} — have been locked by the subject teacher and approved by the class adviser. The grades below are now visible to the record keeper for review.\n\nThe record keeper has a view-only role in the grade pipeline. No further approval is required — these grades are finalized by the adviser once every subject in the student's term is approved.`
            ...
            <section>
              ...
              <ul className="text-muted-foreground space-y-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 size-1.5 shrink-0 rounded-full bg-current" />
                  <span>The record keeper is view-only — no further approval is required from this point.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 size-1.5 shrink-0 rounded-full bg-current" />
