    ...
    <Card className={styles.card}>
      <CardHeader className={styles.header}>
        <div className={styles.headerText}>
          ...
          <CardDescription>
            Custody status and where G7–10 SF10 records are still missing this term.
          </CardDescription>
        </div>
        <CardAction>
              ...
              {missing.length > 0 && (
                <div className={styles.alert}>
                  ...
                  <p className={styles.alertText}>
                    <strong>{missing.length}</strong> G7–10 student
                  ...
                  {filtered.length === 0 ? (
                    <TableRow>
                      <TableCell colSpan={3} className={styles.empty}>
                        {missing.length === 0
                          ? "All G7–10 students have an SF10 record on file."
                          : query.trim()
