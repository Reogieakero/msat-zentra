...
const SLIDES: Slide[] = [
  {
    icon: BookOpen,
    title: "Subjects",
    body: "Maintain the G11–12 subject catalog for every track and strand.",
  },
  {
    icon: LayoutGrid,
    title: "Sections",
  ...
  },
  {
    ...
    body: "Manage the building blocks behind grades 11–12 report cards.",
  },
];
    ...
    <div className={styles.hero}>
      <div className={`${styles.heroPanel} ${styles.heroPanelTitle}`}>
        ...
        <p className={styles.heroSubtitle}>
          Manage the G11–12 academic catalog — subjects, class sections, and
