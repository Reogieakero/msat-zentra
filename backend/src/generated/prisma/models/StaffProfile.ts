...
export type EnumGradeLevelNullableListFilter<$PrismaModel = never> = {
  equals?: $Enums.GradeLevel[] | Prisma.ListEnumGradeLevelFieldRefInput<$PrismaModel> | null
  has?: $Enums.GradeLevel | Prisma.EnumGradeLevelFieldRefInput<$PrismaModel> | null
  hasEvery?: $Enums.GradeLevel[] | Prisma.ListEnumGradeLevelFieldRefInput<$PrismaModel>
  hasSome?: $Enums.GradeLevel[] | Prisma.ListEnumGradeLevelFieldRefInput<$PrismaModel>
  isEmpty?: boolean
}
...
export type StaffProfileCreatehandledGradeLevelsInput = {
...
export interface StaffProfileDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const staffProfileWithUserIdOnly = await prisma.staffProfile.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many StaffProfiles and only return the `userId`
   * const staffProfileWithUserIdOnly = await prisma.staffProfile.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more StaffProfiles and only return the `userId`
   * const staffProfileWithUserIdOnly = await prisma.staffProfile.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
